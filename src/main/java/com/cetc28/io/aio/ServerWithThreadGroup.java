...
public class ServerWithThreadGroup {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        //channelGroup: 真正干活的是线程池里的那些工人 目前就一个线程池,要两个就2
        AsynchronousChannelGroup threadGroup = AsynchronousChannelGroup.withCachedThreadPool(executorService,1);

        //AIO: AsynchronousServerSocketChannel 不管怎么叫,还是那块面板 这里指定了使用一个线程池来干活
        final AsynchronousServerSocketChannel assc = AsynchronousServerSocketChannel.open(threadGroup)
